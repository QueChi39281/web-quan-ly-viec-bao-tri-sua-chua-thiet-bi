...
Use [api/client.js](api/client.js) as the shared FE client. It exposes `authApi`, `userApi`, `deviceApi`, `inventoryApi`, `maintenanceApi`, `notificationApi`, and `auditApi`, and automatically sends the access token and refreshes it once after a `401` response.
...
#### Create Item Request
```
POST /inventories/item-requests
Authorization: Bearer <accessToken>
```
...
```
GET /inventories/item-requests/:id
Authorization: Bearer <accessToken>
```
...
```
GET /inventories/item-requests/plans/:planId
Authorization: Bearer <accessToken>
```
**Required Role:** ADMIN, MANAGER, TECHNICIAN
...
```
PUT /inventories/item-requests/:id
Authorization: Bearer <accessToken>
```
**Required Role:** MANAGER
...
#### Get Plan By ID
```
GET /maintenances/plans/:id
Authorization: Bearer <accessToken>
```

#### List Plans By Status
```
GET /maintenances/plans/status/:status
Authorization: Bearer <accessToken>
```

#### Get Plans By Assignment
```
GET /maintenances/plans/assignments/:employeeId
Authorization: Bearer <accessToken>
```

#### List All Plan Documents
```
GET /maintenances/plans/:id/documents
Authorization: Bearer <accessToken>
```

#### Update Plan
```
PUT /maintenances/plans/:id
Authorization: Bearer <accessToken>
```
**Required Role:** MANAGER
...
#### Start Plan
```
PUT /maintenances/plans/:id/start
Authorization: Bearer <accessToken>
```
**Required Role:** TECHNICIAN
...
#### Complete Plan
```
PUT /maintenances/plans/:id/complete
Authorization: Bearer <accessToken>
```
**Required Role:** TECHNICIAN
...
```
GET /maintenances/repairs/:id
Authorization: Bearer <accessToken>
```

#### Approve Repair Request
```
PUT /maintenances/repairs/:id/approve
Authorization: Bearer <accessToken>
```
**Required Role:** MANAGER
...
```
POST /maintenances/damage-reports
Authorization: Bearer <accessToken>
```
**Required Role:** TECHNICIAN
...
```
GET /maintenances/damage-reports/:id
Authorization: Bearer <accessToken>
```
...
```
POST /maintenances/maintenance-requests
Authorization: Bearer <accessToken>
```
**Required Role:** TECHNICIAN
...
```
GET /maintenances/maintenance-requests/:id
Authorization: Bearer <accessToken>
```

#### Approve Maintenance Request
```
PUT /maintenances/maintenance-requests/:id/approve
Authorization: Bearer <accessToken>
```
**Required Role:** MANAGER
...
```
POST /maintenances/adjust-plans
Authorization: Bearer <accessToken>
```
**Required Role:** TECHNICIAN
...
```
GET /maintenances/adjust-plans/:id
Authorization: Bearer <accessToken>
```

#### Approve Adjust Plan
```
PUT /maintenances/adjust-plans/:id/approve
Authorization: Bearer <accessToken>
```
**Required Role:** MANAGER
...
```
POST /maintenances/acceptance-reports
Authorization: Bearer <accessToken>
```
**Required Role:** TECHNICIAN
...
```
GET /maintenances/acceptance-reports/:id
Authorization: Bearer <accessToken>
```

#### Approve Acceptance Report
```
PUT /maintenances/acceptance-reports/:id/approve
Authorization: Bearer <accessToken>
```
**Required Role:** MANAGER
